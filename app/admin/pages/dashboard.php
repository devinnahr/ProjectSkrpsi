...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
          Hallo Administrator, Selamat Datang di Sistem Informasi Perpustakaan SMP Negeri 1 Kauman Tulungagung
        </div>
        ...
        <div class="row">
            ...
            <img src="../../assets/dist/img/logo.jpg" width="120px" height="140px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 30px; margin-bottom: -20px;">
