...
if ($_GET['aksi'] == "tgl_pinjam") {
    ...
    echo "<link rel='icon' type='icon' href='../../../../assets/dist/img/logo.jpg'>";
    echo "</head>";
    echo "<body onload='window.print()' style='font-family: Quicksand, sans-serif'>";
    echo "<img src='../../../../assets/dist/img/logo.jpg' style='height: 90px; width: 90px; margin-top: 10px; margin-left: 10px; margin-bottom: -50px;'>";
    echo "<img src='../../../../assets/dist/img/logo.jpg' style='display: block; margin-left: auto; width: 90px; margin-bottom: -70px; margin-top: -38px; margin-right: 5px;'>";
