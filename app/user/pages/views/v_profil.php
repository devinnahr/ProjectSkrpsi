        ...
        <div class="row">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="Kelas">
                                    ...
                                    <option value="VIII - G">VTI  - G</option>
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        <!-- Animasi -->
                        <img src="../../assets/dist/img/profile.jpg" style="width: 125px; height: 125px; display: block; margin-left: auto; margin-right: auto; margin-top: -5px; margin-bottom: 15px;" loop autoplay></lottie-player>
                        <!-- -->
