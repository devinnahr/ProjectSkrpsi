<header class="main-header">
    ...
    <a href="dashboard" class="logo" style="font-family: 'Quicksand', sans-serif">
        ...
        <span class="logo-lg"><b>SPENSAKA </b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="../../assets/dist/img/profile.jpg" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="../../assets/dist/img/profile.jpg" class="img-circle" alt="User Image">
