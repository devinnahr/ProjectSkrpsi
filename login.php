...
<head>
    ...
    <!-- Icon -->
    <link rel="icon" type="icon" href="assets/dist/img/logo.jpg">
    <!-- Custom -->
...
<body class="hold-transition login-page" style="font-family: 'Quicksand', sans-serif;">
    <div class="login-box">
        ...
        <div class="login-box-body" style="border-radius: 10px;">
            <img src="assets/dist/img/logo.jpg" height="100px" width="80px" style="display: block; margin-left: auto; margin-right: auto; margin-top: -12px; margin-bottom: 5px;">
            ...
            <p style="text-align: center; font-size: 13px;">Hak Cipta &copy; <?= date('Y'); ?> <?= $row1['nama_app']; ?> by Devinnahr</p>
